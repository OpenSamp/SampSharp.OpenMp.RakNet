...
public class AimSync : ISync
{
    ...
    private void Read(bool outcoming)
    {
        ...
        CameraFrontVector = new Vector3((float)result["cameraFrontVector_0"], (float)result["cameraFrontVector_1"],
            (float)result["cameraFrontVector_2"]);
        CameraPosition = new Vector3((float)result["cameraPosition_0"], (float)result["cameraPosition_1"],
            (float)result["cameraPosition_2"]);
