...
public class TrailerSync(BitStream bs) : ISync
{
    ...
    private void Read(bool outcoming)
    {
        ...
        if (outcoming) FromPlayerId = (int)result["fromPlayerId"];
        ...
        AngularVelocity = new Vector3((float)result["angularVelocity_0"], (float)result["angularVelocity_1"],
            (float)result["angularVelocity_2"]);
    }
